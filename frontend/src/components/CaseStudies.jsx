...
//       <div>
//         <h2 className="text-4xl font-bold text-black-600 mb-3">Case Studies</h2>
...
//             <div
//               key={index}
//               className="bg-blue-300 border rounded-2xl p-6 shadow-xl hover:scale-105 transition-transform"
//             >
