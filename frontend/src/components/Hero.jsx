      ...
      <div className="flex flex-col md:flex-row items-center md:items-start justify-between gap-12">
        ...
        <div className="w-full md:w-1/2 text-center md:text-left">
          ...
          <div className="mt-10 flex flex-col sm:flex-row justify-center md:justify-start gap-4">
            <button className="bg-black text-white border px-6 py-3 rounded-lg flex items-center justify-center gap-2 hover:bg-[#5465ff] transition">
              Launch Editor <ArrowRight size={18} />
            </button>
            <button className="bg-black border text-white px-6 py-3 rounded-lg hover:bg-[#5465ff] transition">
              Search Job
            </button>
          </div>
        </div>
