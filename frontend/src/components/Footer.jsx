...
//             <img src="/Images/codehire.png" alt="logo" className="invert size-10 brightness-0 brightness-200" />
...
//         {/* Contact Info */}
//         <div>
//           <span className="inline-block bg-[#5465ff] text-white px-3 py-1 rounded mb-4">Contact us:</span>
//           <ul className="space-y-2 text-sm">
//             <li>Email: <a href="mailto:info@codehire.com" className="hover:underline">info@codehire.com</a></li>
...
//               <button
//                 type="submit"
//                 className="bg-blue-700 px-4 py-2 rounded-r text-white font-semibold hover:bg-[#5465ff]"
//               >
//                 Subscribe
//               </button>
//             </div>
  ...
  return (
    <footer className="bg-black text-white px-4 sm:px-6 md:px-10 lg:px-20 py-10 mt-6 border rounded-t-4xl">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          <div className="flex items-center gap-3 mb-4">
            <img
              ...
              alt="logo"
              className="invert w-10 h-10 brightness-0 brightness-200"
            />
        ...
        <div>
          <form className="space-y-4">
            <label htmlFor="email" className="block text-sm sm:text-base">Subscribe to news:</label>
            <div className="flex flex-col gap-3 md:gap-0   sm:flex-row ">
              <input
                type="email"
                id="email"
                placeholder="Email"
                className="flex-grow px-4 py-2 rounded-t sm:rounded-l sm:rounded-tr-none bg-gray-800 text-white border border-white placeholder-gray-400"
              />
              <button
                type="submit"
